...
if __name__ == '__main__':
    ...
    print('#' * 10)
    print('**Finetune** Downsampling rate: {}; Running time: {}'.format(downsampling_ratio, run_time))
    ...
    model.save(os.path.join('models', '{}_Finetune_{}'.format(run_id, str(run_time))))
