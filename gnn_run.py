...
if __name__ == '__main__':
    ...
    print('#'*10)
    print('**GNN** Downsampling rate: {}; Running time: {}'.format(downsampling_ratio, run_time))
    ...
    with open('configs/{}_{}_extra_settings.json'.format(run_id, run_time), 'w') as fp:
    ...
    GNN.save(os.path.join('models', '{}_GNN_{}'.format(run_id, str(run_time))))
